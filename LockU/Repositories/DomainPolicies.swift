...
struct MemoryPresentationResolver {
...
enum StoredImageFormat { case jpeg, png }
struct ImageFormatPolicy { func format(for style: MemoryImageStyle) -> StoredImageFormat { style == .cutout ? .png : .jpeg } }
struct DefaultMemoryPresentationPolicy {
...
struct LockerPlacementValidator {
...
struct LockerDecorationValidator {
